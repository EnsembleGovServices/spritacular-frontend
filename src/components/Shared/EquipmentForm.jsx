        ...
        <>
         <Col md="12">
            <FormGroup>
                ...
                <span className="d-inline-block mt-1 fs-6 opacity-75 ex-text"><b className="me-1">e.g.</b>Canon</span>
            ...
            <FormGroup>
                ...
                onChange={(e)=>handleInput1(e)}
                />
                <span className="d-inline-block mt-1 fs-6 opacity-75 ex-text"><b className="me-1">e.g.</b>35 mm</span>
            ...
            <FormGroup>
                ...
                onChange={(e)=>handleInput1(e)}
                />
                <span className="d-inline-block mt-1 fs-6 opacity-75 ex-text"><b className="me-1">e.g.</b>1.4</span>
                {error?.data?.aperture &&
            ...
            <FormGroup>
                ...
                onChange={(e)=>handleInput1(e)}
                />
                <span className="d-inline-block mt-1 fs-6 opacity-75 ex-text"><b className="me-1">e.g.</b>100</span>
            </FormGroup>
            </Col>
            <Col md="6">
            <FormGroup>
                ...
                onChange={(e)=>handleInput1(e)}
                />
                <span className="d-inline-block mt-1 fs-6 opacity-75 ex-text"><b className="me-1">e.g.</b>1/15</span>
            </FormGroup>
            </Col>
            <Col md="6">
            <FormGroup>
            ...
            <FormGroup>
                ...
                onChange={(e)=>handleInput1(e)}
                />
                <span className="d-inline-block mt-1 fs-6 opacity-75 ex-text"><b className="me-1">e.g.</b>Camera Time</span>
            </FormGroup>
            </Col>
            <Col md="12">
            <div className="border-line"/>
            <FormGroup>
                ...
                onChange={(e)=>handleInput1(e)}
                />
                <span className="d-inline-block mt-1 fs-6 opacity-75 ex-text"><b className="me-1">e.g.</b>Polarizing Filter</span>
            </FormGroup>
            </Col>
            </>
    )
