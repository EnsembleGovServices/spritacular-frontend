            ...
            <Col md={12} className="mb-5">
                ...
                <FormGroup>
                    ...
                    <Input
                        ...
                        onChange={(e)=>handleImageInput(e)}
                    />
                    <span className="d-inline-block mt-1 opacity-75 ex-text"><b className="me-1">e.g.</b> +/- 3 sec  or  +/- 1 min</span>
                </FormGroup>
            </Col>
            <Col md={12} className="mb-5">
                ...
                :
                    <FormGroup>
                        ...
                        <Input
                            ...
                            onChange={(e)=>handleImageInput(e)}
                        />
                        <span className="d-inline-block mt-1 opacity-75 ex-text"><b className="me-1">e.g.</b> 120°</span>
                    </FormGroup>
                }
