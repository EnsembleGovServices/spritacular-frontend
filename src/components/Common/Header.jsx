...
const Header = (props) => {
  ...
  useEffect(() => {
    if (auth?.user) {
      axios
        .get(baseURL.api + "/notification/user_notification/", {
          headers: {
  ...
  return (
    <>
      ...
      >
        <Link
          to={routeUrls.home}
          className="navbar-brand p-0 position-relative"
          title="Spritacular"
          onClick={() => setActive("")}
        >
          <img src={`${cdn.url}/logo.png`} alt="Spritacular" className="logo" />
          <img
            src={`${cdn.url}/black-logo.png`}
            alt="Spritacular"
            className="on-scroll-logo"
          />
          {process.env.NODE_ENV === "development" && (
            <div className="showUserTag">
              {admin && <span>{admin ? "Admin" : ""}</span>}
              {trainee && <span>{trainee ? "Trainee" : ""}</span>}
              {normalUser && <span>{normalUser ? "User" : ""}</span>}
            </div>
          )}
        </Link>
          ...
          <Nav navbar>
            ...
            <NavItem>
              ...
              >
                ...
                <DropdownMenu>
                  <DropdownItem
                    className={active === "about-1" ? "active p-0" : "p-0"}
                  >
                    <Link
                      className="px-3 py-1"
                      to={routeUrls.about}
                  ...
                  <DropdownItem
                    className={active === "about-2" ? "active p-0" : "p-0"}
                  >
                    <Link
                      className="px-3 py-1"
                      to={routeUrls.policy}
                  ...
                  {/*    <Link className="px-3 py-1" to={routeUrls.policy + '?code=true'} title="Code of Conduct"*/}
            ...
            <NavItem>
              ...
              >
                ...
                <DropdownMenu>
                  <DropdownItem
                    className={active === "resources-1" ? "active p-0" : "p-0"}
                  >
                    <Link
                      className="px-3 py-1"
                      to={routeUrls.blog}
                  ...
                  <DropdownItem
                    className={active === "resources-2" ? "active p-0" : "p-0"}
                  >
                    <Link
                      className="px-3 py-1"
            ...
            <NavItem>
              ...
              >
                ...
                <DropdownMenu>
                  <DropdownItem
                    className={active === "community-1" ? "active p-0" : "p-0"}
                  >
                    <Link
                      className="px-3 py-1"
                      to={routeUrls.home}
                  ...
                  <DropdownItem
                    className={active === "community-2" ? "active p-0" : "p-0"}
                  >
                    <Link
                      className="px-3 py-1"
                      to={routeUrls.home}
                  ...
                  <DropdownItem
                    className={active === "community-3" ? "active p-0" : "p-0"}
                  >
                    <Link
                      className="px-3 py-1"
                      to={routeUrls.home}
                  ...
                  <DropdownItem
                    className={active === "community-4" ? "active p-0" : "p-0"}
                  >
                    <Link
                    className="px-3 py-1"
                      to={routeUrls.home}
          ...
          <div className="after-login-right-menu">
            ...
            >
              ...
              <DropdownMenu container="body">
                ...
                >
                 <p className="px-3 py-1 m-0">Change Password</p>
                </DropdownItem>
                <DropdownItem
                className="p-0"
                  onClick={() => {
                ...
                >
                  <p className="px-3 py-1 m-0">Logout</p>
                </DropdownItem>
              </DropdownMenu>
            </Dropdown>
          </div>
