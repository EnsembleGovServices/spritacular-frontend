                ...
                {loading &&
                    <div className="loading-wrapper">
                        <ContentLoader
                            ...
                            viewBox="0 5 320 410" height={300} width={300}
                        >
                            <rect x="150" y="9" rx="0" ry="0" width="50" height="30"/>
                            <rect x="205" y="9" rx="0" ry="0" width="50" height="30"/>
                            <rect x="260" y="9" rx="0" ry="0" width="50" height="30"/>
                            <rect x="150" y="58" rx="0" ry="0" width="160" height="10"/>
                            <rect x="150" y="84" rx="0" ry="0" width="160" height="10"/>
                            <rect x="150" y="109" rx="0" ry="0" width="160" height="10"/>
                            <rect x="150" y="131" rx="0" ry="0" width="160" height="100%"/>
                            <rect x="10" y="10" rx="0" ry="0" width="128" height="100%"/>
                        </ContentLoader>
                    </div>
                }
